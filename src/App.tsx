...
// initialize axios interceptors (attach token when present and prevent protected calls without token)
import "@/lib/axiosSetup2";
...
export default function App() {
  ...
  return (
    <Routes>
      ...
      <Route path="/privacy" element={<WebsiteRoute element={<LegalPage type="privacy" />} />} />
      <Route path="/terms" element={<WebsiteRoute element={<LegalPage type="terms" />} />} />
