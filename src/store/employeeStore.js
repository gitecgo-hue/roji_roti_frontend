...
const useEmployeeStore = create((set, get) => ({
    ...
    getEmployee: async () => {
        ...
        while (attempt < maxAttempts) {
            try {
                ...
                const response = await axios.get(`${api}/employees/profile`, headers);
    ...
    getSavedJobs: async () => {
        ...
        try {
            ...
            const headers = { headers: { Authorization: `Bearer ${token}` } };
            const response = await axios.get(`${api}/employees/jobs/saved`, headers);
            const payload = unwrapPayload(response.data);
    ...
    getDashboard: async () => {
        ...
        try {
            ...
            if (!token) { set({ isLoading: false }); return null; }
            const headers = { headers: { Authorization: `Bearer ${token}` } };
            const response = await axios.get(`${api}/employees/dashboard`, headers);
            const payload = unwrapPayload(response.data);
